...
from skyplane.replicate.solver import ThroughputSolverILP
...
def main(args):
    ...
    df.to_csv(skyplane_root / "data" / "pareto.csv", index=False)


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--cost-path", type=str, default=str(skyplane_root / "data" / "throughput" / "df_throughput_agg.csv"))

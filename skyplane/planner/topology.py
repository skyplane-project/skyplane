from skyplane.broadcast.gateway.gateway_program import GatewayProgram, GatewaySend, GatewayWriteLocal, GatewayWriteObjectStore
    ...
    def get_outgoing_paths(self, gateway_id: str): 
        ...
        for operator in self.gateways[gateway_id].gateway_program.get_operators(): 
            if isinstance(operator, GatewaySend): 
                ...
                assert operator.target_gateway_id in self.gateways, f"Gateway {operator.target_gateway_id} not found in gateway list {self.gateways}"

...
MODULES = [SkyApiKeyConfig, SkyEndpointConfig, SkyVPCConfig,
           SkySshKeyConfig, SkyImageConfig, FloatingIpConfig, SkyProfileConfig]

from skyplane.compute.ibmcloud.gen2.utils import load_base_config

def load_config(iam_api_key, region=None,

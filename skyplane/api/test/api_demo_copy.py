...
if __name__ == "__main__":
    ...
    dp = client.dataplane("aws", "us-east-1", "aws", "us-west-2", n_vms=1)
    with dp.auto_deprovision():
        dp.provision(spinner=True)
        dp.queue_copy("s3://jason-us-east-1/fake_imagenet/", "s3://jason-us-west-2/fake_imagenet_1/", recursive=True)

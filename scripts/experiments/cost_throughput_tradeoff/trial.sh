...
skylark replicate-random-solve $1 $2 --num-gateways 1 --num-outgoing-connections 64 -s $((32*1024)) --reuse-gateways --solve --solver-required-throughput-gbits $3 |& tee $out_file
